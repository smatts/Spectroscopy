...
\includeonly{4_plasmonics/1_hybridization/hybrid.tex}
%\includeonly{4_plasmonics/4_lattice/cda}
...
\include{4_plasmonics/1_hybridization/hybrid.tex}
\include{4_plasmonics/2_surface/surface}
\include{4_plasmonics/3_rods/rods}
\include{4_plasmonics/4_lattice/cda}
