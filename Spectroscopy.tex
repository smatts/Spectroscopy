...
\end{tikzpicture} \ \ 
\href{https://raw.githubusercontent.com/MarkusLippitz/Spectrosocpy/to-be-published/\mystring/pluto/#1}{download}
\ \ 
\href{https://binder.plutojl.org/v0.16.4/open?url=https\%253A\%252F\%252Fraw.githubusercontent.com\%252FMarkusLippitz\%252FSpectrosocpy\%252Fto-be-published\%252F\mystring\%252Fpluto\%252F#1}{run on binder}
}}  
