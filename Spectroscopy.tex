...
%\includeonly{4_nonlinear/1_shg/shg}
%\includeonly{4_nonlinear/2_fwm/fwm}
%\includeonly{4_nonlinear/3_tpe/tpe}
\includeonly{4_nonlinear/4_2d_spec/two-dim-spec}

%\includeonly{5_nanooptics/2_tmatrix/tmatrix}
%\includeonly{5_nanooptics/3_dda/dda}
...
%%
\include{5_nanooptics/2_tmatrix/tmatrix}
\include{5_nanooptics/3_dda/dda}
