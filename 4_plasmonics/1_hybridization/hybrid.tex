...
\input{\currfiledir fig_schumacher11.tikz.tex}
\caption{Enhancement of a transient absorption signal by plasmon hybridization \cite{Schumacher11}.
The inset shows a SEM micrograph of the gold nanodiscs.
...
%\includegraphics[width=55mm]{\currfiledir hybrid-levels.png}
...
\begin{figure}
\includegraphics[width=110mm]{\currfiledir  drude_vs_au_hybrid.pdf}
...
\includegraphics[width=105mm]{\currfiledir fermi-dirac.png}
...
\begin{figure}
\input{\currfiledir gamma_vs_wp_at_dband.tikz.tex}
%\includegraphics[width=110mm]{\currfiledir plasmon_pp_spec.pdf}
...
\includegraphics[width=60mm]{\currfiledir disc_transient.pdf}
