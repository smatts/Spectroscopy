...
\item Use the Pluto script\pluto{hybridization.jl} to investigate the mode splitting in small Rayleigh particles. Compare the absorption spectrum with the analytic equations for resonance position and amplitude. Discuss differences.
\end{questions}
...
\begin{questions}
\item Use the Pluto script\pluto{jc_gold.jl} to investigate  difference between the Drude model and the measured dielectric function of gold.
