\renewcommand{\lastmod}{February 3, 2022}
...
The Pluto script\pluto{dipole_at_interface.jl} plots the 3D angular emission pattern of a dipole in front of a glass surface, using a scheme that is also able to calculate the more complicated layer structures discussed below.
