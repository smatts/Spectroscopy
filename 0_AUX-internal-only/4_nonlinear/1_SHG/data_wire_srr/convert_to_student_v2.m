...
filename = 'Esplitring1750_x_pol_new';
%filename = 'Esplitring1750_y_pol_new';
%filename = 'Ewire1400_y_pol_new';
%filename = 'Ewire1400_x_pol_new';
...
data_out = [x(ind), y(ind), real(Ex(ind)), imag(Ex(ind)), real(Ey(ind)), imag(Ey(ind)), real(Ez(ind)), imag(Ez(ind))];

save([filename '.dat'],'data_out','-ascii')
