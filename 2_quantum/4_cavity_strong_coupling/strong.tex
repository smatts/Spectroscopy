...
Which dipole moment is required so that a coupling strength of $\hbar g = 80$~meV is reached, as in \cite{Reithmaier04}. Does it help that the authors used a pillar instead of a planar cavity?
