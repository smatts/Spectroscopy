...
\end{equation}
where $T_2^\star$ is called pure dephasing time. The $T_1$ time enters, as a decaying population also removes coherence. The prefactor of $2$ is a consequence of effective spin-$1/2$-system. On the Bloch sphere, these processes let Bloch vector move back to the north pole, but not along the surface of the sphere but with varying length of the vector.\sidenote{In the original work of Bloch this scheme was applied to the magnetization of a spin-$1/2$ system which decays towards the center of the sphere, as thermal energy leads to almost equal population of both states.}
